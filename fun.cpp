...
void SweeperGame::InitGame()
{
	...
	loadimage(&GameStart, _T("images/start.png"),256,64);              //游戏开始图片
	loadimage(&GameStart1, _T("images/start1.png"), 256, 64);              //游戏开始悬停图片
    loadimage(&GameExit, _T("images/end.png"),256,64);               //退出游戏按钮图片
	loadimage(&GameExit1, _T("images/end1.png"), 256, 64);               //退出游戏按钮悬停图片
    ...
    loadimage(&Simple1, _T("images/Simple1.png"), 256, 64);
    loadimage(&Medium, _T("images/Medium.png"), 256, 64);
    loadimage(&Medium1, _T("images/Medium1.png"), 256, 64);
    loadimage(&Difficult, _T("images/Difficult.png"), 256, 64);
    loadimage(&Difficult1, _T("images/Difficult1.png"), 256, 64);
...
{  
	...
	while (1)
	{
        ...
        putimage(472, 300, &GameStart, SRCCOPY);                //级
        putimage(472, 380, &history_scores1, SRCCOPY);          //画
        putimage(472, 460, &GameExit, SRCCOPY);                 //面
        FlushBatchDraw();                                       //
        flag0 = hoverstart1();                                  //
        
        switch (flag0)//switch最外层为第二级画面
        {
            case 1:
                {
                    int flag1;
